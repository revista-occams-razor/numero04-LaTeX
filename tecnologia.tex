...
% Cuerpo del artículo
Fijaos que este es el método que más empleamos los humanos para
...
automático de huellas). Si en Barajas (el aeropuerto de Madrid) hay casi 150.000 pasajeros al día
...
{\footnotesize\url{http://opencv.willowgarage.com/wiki/}}. Ufff,
...
over the Internet''. Además, estos estudios reciben
...
\rput(8,-14.0){\resizebox{!}{16cm}{{\epsfbox{images/general/promo-1.eps}}}}
...
\textsf{Aalgoritmo de Viola}

{\footnotesize\url{http://en.wikipedia.org/wiki/Robust_real-time_object_detection}}

{\footnotesize\url{http://www.cmucam.org/wiki/viola-jones}}

\medskip

\textsf{Librería OpenCV}

{\footnotesize\url{http://opencv.willowgarage.com/wiki/}}
{\footnotesize\url{http://sourceforge.net/projects/opencvlibrary/}}
\medskip
