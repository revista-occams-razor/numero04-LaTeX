...
librería libjpeg. También os contaremos cómo utilizar un formato mucho
...
ya que esto va a hacer nuestro código de visualización mucho más
sencillo.
...
preguntaréis. Básicamente son los siguientes: El número de cuadros que
...
qué cuadro capturar, o dicho de otra forma, que parte del buffer
utilizar.
...
\begin{entradilla}
{\em Nuestro {\color{introcolor} sencillo interfaz con V4L}, nos
permite capturar imágenes de forma {\color{introcolor}mú rápida}}
\end{entradilla}
...
nos permiten decirle a GLUT qué función tiene que ejecutar cuando
...
se ha pulsado ninguna tecla ni se ha movido el ratón.
