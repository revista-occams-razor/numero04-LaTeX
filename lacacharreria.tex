...
que todos conocemos es la luz visible, lo bueno de esta es que la
podemos percibir. Esta radiación se propaga, es decir, se mueve y llega
...
recibiendo radiación infrarroja.
...
en Occam's... qué, todavía no os habéis leído el artículo sobre video
...
contrario... bueno, eso lo podréis controlar vosotros mismos ;).
...
velado... sí, quien diría que algún día eso no sería tan fácil de
...
Para nuestra cámara concreta, utilizamos un perforador de hojas que
...
historia. Este último caso os lo dejamos como ejercicio :)
...
voluntario para enseñar sus vergüenzas en aras de la ciencia, pero
enseguida os damos algunas indicaciones sobre este tema.
...
color elimina el típico color verde.
...
Unas imágenes curiosas eh?... Pero muchos os preguntaréis, y para que
sirve esto. Bueno, además de para quedarte con los colegas. La
pregunta exacta que probablemente se os esté viniendo a la cabeza es: ¿ Qué hace
una gente tan discreta como los tíos de Occam's, haciendo algo para
chulear?
...
de vista de los denominado MMI (Man Machine Interface o Interface
Hombre Máquina).
...
prácticamente trivial el determinar la posición de esas fuentes de luz IR
en la imagen.
...
por ejemplo para un dispositivo apuntador a utilizar en un sistema de
...
Este tipo de soluciones son utilizados, por ejemplo, por el mando de la consola Wii (el
...
La cámara detecta una serie de puntos de referencia
...
denominada FTIR que son las siglas de Frustrated Total Internal
...
la luz utilizada es IR, pero utilizando una cámara IR, esos
