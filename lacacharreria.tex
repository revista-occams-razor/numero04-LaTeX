...
lento) que varíe, veremos un color u otro.
...
Por qué lo del infra y el ultra... muchos ya lo habréis imaginado,
...
como infrarrojo cercano... os imagináis por qué no?. Efectivamente,
porque es el que está más cerca del espectro visible. Sí, los más 
...
Así que ahora que tenemos una idea general de que es lo qué estamos
haciendo... pues vamos a ponernos manos a la obra.


\sectiontext{white}{black}{DESMONTANDO LA CÁMARA}

Nuestra webcam es una Logitech Messenger. Sí, aprovechamos todo aquí
...
Lo que si es cierto es que al poder ``capturar'' la radiación
...
Aquí podéis ver como convertimos una moderna e informal chaqueta de
