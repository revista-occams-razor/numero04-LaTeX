...
utilizar un buffer de 1Kb que será más que suficiente para nuestras pruebas.
...
requieren conocer qué paquete se envió en primer lugar. Los que andéis
aburridos podéis extender este ejemplo para que se parezca más a ping}}
\end{minipage}
}}

\sectiontext{white}{black}{DETECTANDO ESCANEOS SIGILOSOS}
...
un paquete, por cuestiones prácticas nos interesa definir una
...
\rput(8,-3.0){\resizebox{!}{8cm}{{\epsfbox{images/general/publi.eps}}}}
