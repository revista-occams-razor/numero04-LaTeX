...
\rput(5.0,-3.2){\resizebox{16cm}{!}{{\epsfbox{images/ratas/header.eps}}}}
...
la sentencia if (y la siguiente sección) que sigue a continuación os
la podéis ahorrar si no 
...
Supongo que ahora os estaréis preguntando \ldots ¿Y cómo son esos
filtros? Bueno, pues para tener una descripción detallada de como
definirlos 
...
necesitáis hacer 5 llamadas a la librería} 
\end{entradilla} 

Una explicación detallada de como funciona una pila de protocolos se
sale de los objetivos de este pequeño artículo, pero jugando con
libpcap, un par 
